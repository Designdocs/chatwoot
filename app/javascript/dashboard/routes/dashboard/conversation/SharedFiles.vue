    ...
    <section v-if="mediaAttachments.length" class="flex flex-col gap-2.5">
      <header class="flex items-center justify-between px-0.5">
        ...
        >
          ...
          <span
            class="ms-1 font-semibold tracking-normal normal-case text-n-slate-10"
          >
        ...
        >
          <template v-if="!isOverflowTile(index)">
            ...
            <span
              ...
              "
              class="absolute text-xxs font-semibold tabular-nums transition-opacity bottom-1.5 ltr:right-1.5 rtl:left-1.5 text-white [text-shadow:_0_1px_3px_rgba(0,0,0,0.95),_0_0_10px_rgba(0,0,0,0.7)] group-hover:opacity-0"
            >
              {{ displayDuration(attachment) }}
            </span>
            ...
            <span
              ...
              class="absolute text-xxs font-semibold transition-opacity opacity-0 bottom-1.5 ltr:left-1.5 rtl:right-1.5 text-white [text-shadow:_0_1px_3px_rgba(0,0,0,0.95),_0_0_10px_rgba(0,0,0,0.7)] group-hover:opacity-100"
            >
    ...
    <section v-if="fileAttachments.length" class="flex flex-col gap-2.5">
      ...
      <ul class="flex flex-col gap-0.5">
        ...
        >
          ...
          >
            <p class="text-sm font-semibold truncate text-n-slate-12 mb-1">
